...
class TimeFrameScaler:
    ...
    # 🔧 科学的lag范围（基于Advances in Financial ML + 加密货币特性）
    # 理论依据：短期时间框架的有效预测窗口应在1-4小时内
    # 超过4小时，信号会被噪音淹没（特别是加密货币的高波动性）
    base_lag_ranges = {
        '5m': (2, 36),    # 10分钟-3小时（避免lag=1的过度噪音）
        '15m': (4, 16),   # 1小时-4小时（核心修改：缩短从20→16，适合15m高频交易）
        '30m': (3, 12),   # 1.5小时-6小时
        '1h': (2, 12),    # 2小时-12小时
        '2h': (2, 8),     # 4小时-16小时
        '4h': (2, 6),     # 8小时-24小时
